...
#SBATCH --output=/home/ofourkioti/Projects/Neighbor_constrained_attention_based_MIL/tcga_results/nystromformer_k_3.txt
...
for i in {0..4};
do python run.py --epochs 100 --experiment_name nystromformer_k_3  --k 3 --dataset tcga --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/TCGA_data/features/h5_files  --label_file label_files/tcga_data.csv --csv_file tcga_csv_files/splits_${i}.csv --save_dir TCGA_Saved_model;
done
