...
for i in {0..4};
do python run.py  --k 3 --experiment_name dense  --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/cam-16/dsmil-feats/h5_files/ --label_file label_files/camelyon_data.csv --csv_file camelyon_csv_files/splits_${i}.csv  --epoch 100;
done
