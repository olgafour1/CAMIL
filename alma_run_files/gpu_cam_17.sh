...
#SBATCH --output=/home/ofourkioti/Projects/Neighbor_constrained_attention_based_MIL/cam_17_results/cam_17_num_land_256.txt
...
for i in {0..4};
do python run.py --experiment_name cam_17_num_land_256  --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/cam-17/feats/h5_files/ --label_file label_files/camelyon_17.csv --csv_file camelyon_17_splits/splits_${i}.csv  --epoch 200 --save_dir cam17_Saved_model
done
