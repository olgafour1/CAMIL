...
for i in {0..4};
do python run.py --experiment_name res_1  --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/cam-17/feats/h5_files/ --label_file label_files/camelyon_17.csv --csv_file camelyon_17_splits/splits_${i}.csv --lambda1 1 --epoch 200 --eta 1 --topk 10 --save_dir cam17_Saved_model
done
